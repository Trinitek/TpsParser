...
public readonly struct Maybe<T> : IEquatable<Maybe<T>>
{
    ...
    public T Value =>
        HasValue
        ? _value!
        : throw new InvalidOperationException($"The TPS object value is not representable as a {typeof(T)}.");
    ...
    public bool Equals(Maybe<T> other) =>
        ...
        && (!HasValue || EqualityComparer<T>.Default.Equals(_value, other.Value));
