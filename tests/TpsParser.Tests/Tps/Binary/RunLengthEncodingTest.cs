...
namespace TpsParser.Tests.Tps.Binary
{
    ...
    public class RunLengthEncodingTest
    {
        ...
        public void ShouldUnpackRleSimpleBlock()
        {
            ...
            var ra = new TpsReader(new byte[] { 0x01, 0x31, 0x07 }).UnpackRunLengthEncoding();
        ...
        public void ShouldUnpackRleDoubleBlock()
        {
            ...
            var ra = new TpsReader(new byte[] { 0x01, 0x31, 0x07, 0x02, 0x32, 0x33, 0x03 }).UnpackRunLengthEncoding();
        ...
        {
            var ra = new TpsReader(new byte[] { 0x01, 0x31 }).UnpackRunLengthEncoding();
        ...
        public void ShouldUnpackRleLongSkip()
        {
            ...
            var ra = new TpsReader(block).UnpackRunLengthEncoding();
        ...
        {
            var ra = new TpsReader(new byte[] { 0x01, 0x31, 0x80, 0x01 }).UnpackRunLengthEncoding();
