...
internal sealed partial class TpsParserTest
{
    ...
    {
        const string filename = "Resources/table-with-memos.tps";
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(((ClaFString)rows[0].Values["Name"]).ToString(), Is.EqualTo("Joe Smith".PadRight(64, ' ')));
            ...
            Assert.That(((ClaFString)rows[1].Values["Name"]).ToString(), Is.EqualTo("Jane Jones".PadRight(64, ' ')));
            ...
            Assert.That(((ClaFString)rows[2].Values["Name"]).ToString(), Is.EqualTo("John NoNotes".PadRight(64, ' ')));
            ...
            Assert.That(((ClaFString)rows[3].Values["Name"]).ToString(), Is.EqualTo("Jimmy OneNote".PadRight(64, ' ')));
