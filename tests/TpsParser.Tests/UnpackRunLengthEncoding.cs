...
internal sealed class TestRleDecoder
{
    ...
    [Test]
    public void ShouldUnpackRealPagePayload()
    {
        byte[] compressedPageData = [
            0x02, 0xc0, 0x00, 0x03, 0x05, 0xc0, 0x11, 0x00, 0x09, 0x00, 0x03, 0x17, 0x01, 0xf3, 0x00, 0x00,
            0x00, 0x02, 0x00, 0x0f, 0x17, 0x06, 0x00, 0x3b, 0x3b, 0x0c, 0xc4, 0x0e, 0x00, 0x06, 0x00, 0xf6,
            0xf3, 0x01, 0x00, 0x06, 0x0e, 0xc4, 0x40, 0x00, 0x07, 0x00, 0xfa, 0x00, 0x00, 0x01, 0x00, 0x08,
            0x00, 0x02, 0x00, 0x04, 0x13, 0x05, 0x00, 0x00, 0x54, 0x49, 0x4d, 0x3a, 0x43, 0x6c, 0x6f, 0x63,
            0x6b, 0x49, 0x6e, 0x00, 0x01, 0x00, 0x04, 0x00, 0x04, 0xa1, 0x04, 0x05, 0x04, 0x00, 0x54, 0x49,
            0x4d, 0x3a, 0x43, 0x6c, 0x6f, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00,
            0x00, 0x01, 0x00, 0xc4, 0x87, 0x04, 0x06, 0x00, 0xfb, 0x01, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04,
            ...
            ,
            ];

        byte[] decompressedPageData = [
            , 
            ...
            0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a, 0x00, 0x00, 
            ...
            , 
            ...
            0x01, 0x01, 0x00, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0xc0, 0x0c, 0x00, 0x08, 0x00, 0xfe, 0x55, 0x4e, 0x4e, 0x41, 0x4d, 0x45, 0x44, 
            0x00, 0x00, 0x00, 0x01
            ];

        bool result = RleDecoder.TryUnpack(
            compressedPageData,
            expectedUnpackedSize:
            decompressedPageData.Length,
            ErrorHandlingOptions.Strict,
            out byte[]? unpacked0);
